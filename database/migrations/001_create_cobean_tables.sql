-- Migration: Create Cobean database tables
-- Created: 2025-01-25
...
COMMENT ON TABLE thoughts IS 'User goals and aspirations';
COMMENT ON TABLE actions IS 'Daily actions generated for thoughts';
COMMENT ON TABLE user_choices IS 'User decisions and interactions with actions';
COMMENT ON TABLE action_history IS 'Final state tracking for completed actions';
COMMENT ON TABLE user_preferences IS 'Long-term user preference patterns';