...
async function testCozeAPIWithCorrectBot() {
  try {
    ...
    const chatParams = {
      ...
      additional_messages: [
        {
          role: RoleType.User,
          content: 'Hello, can you help me develop the intelligent assistant idea?',
          content_type: 'text',
        },
      ],
    };
